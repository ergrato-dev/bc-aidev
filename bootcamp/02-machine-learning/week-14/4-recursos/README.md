# 📚 Recursos Adicionales - Semana 14
...
- **category_encoders**: Más tipos de encoding para categóricas
  ...
  ```
- **feature-engine**: Transformadores adicionales
  ```bash
...
- [Sklearn Cheat Sheet](https://scikit-learn.org/stable/tutorial/machine_learning_map/index.html)
- [Pandas Cheat Sheet](https://pandas.pydata.org/Pandas_Cheat_Sheet.pdf)
- [Feature Engineering Cheat Sheet](https://www.kaggle.com/getting-started/35038)
